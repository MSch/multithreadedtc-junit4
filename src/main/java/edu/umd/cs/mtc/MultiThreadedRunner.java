...
public class MultiThreadedRunner extends BlockJUnit4ClassRunner {
	...
	final MultithreadedTest multithreadedTestAnnotation = method
		.getAnnotation(MultithreadedTest.class);
	if (multithreadedTestAnnotation != null)
	    return new RunThreadsThenInvokeMethod(method, test,
		    multithreadedTestAnnotation.times());
	else
